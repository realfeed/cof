...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/JKBigInteger2/JKBigInteger2.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/RNAWSCognito/RNAWSCognito.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RNSound/RNSound.framework"
